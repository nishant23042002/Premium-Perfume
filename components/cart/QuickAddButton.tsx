...
export function QuickAddButton({
  ...
  return (
    <button
      ...
      disabled={outOfStock || isPending}
      className={cn(
        "w-full border border-ink/20 py-2 font-sans text-xs font-medium uppercase tracking-[0.08em] text-ink transition-colors hover:border-accent-dark hover:text-accent-dark disabled:opacity-40",
